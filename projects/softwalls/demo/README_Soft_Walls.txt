$Id: README_Soft_Walls.txt 187 2013-12-17 04:19:08Z cxh $
...
1. Download and install Java and Java 3D.
...
* You might experience out of memory errors.  There are four data sets
of roughly 1,000,000 doubles each that consume quite a bit of memory.
If the model appears to hang, try restarting vergil.
